...
public:
	...
	TSharedPtr<FJsonObject> BuildInputSchema() const override
	{
		return FMcpSchemaBuilder()
			...
			.String(TEXT("classPath"), TEXT("Reflection class path for a function or cast target."))
			.String(TEXT("operation"), TEXT("Reflected arithmetic function name."))
			.String(TEXT("inputEventType"), TEXT("Input event type: axis or enhanced."))
			.String(TEXT("graphType"), TEXT("Graph type: event or function."))
