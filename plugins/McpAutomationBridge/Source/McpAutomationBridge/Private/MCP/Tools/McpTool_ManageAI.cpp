...
public:
	...
	TSharedPtr<FJsonObject> BuildInputSchema() const override
	{
		return FMcpSchemaBuilder()
			...
			.String(TEXT("controllerName"), TEXT("Runtime AI controller name or label."))
			.String(TEXT("world"), TEXT("Runtime world: PIE (default) or Editor."))
			.String(TEXT("pawnClassPath"), TEXT("Runtime pawn class or Blueprint path."))
			.String(TEXT("pawnBlueprintPath"), TEXT("Runtime pawn Blueprint path."))
			.String(TEXT("controllerClassPath"), TEXT("Runtime AI controller class or Blueprint path."))
			.String(TEXT("querierName"), TEXT("Runtime EQS querier actor name or label."))
			.Number(TEXT("stuckSpeedThreshold"), TEXT("Velocity threshold used for stuck-candidate diagnostics."))
			.Object(TEXT("location"), TEXT("Runtime spawn location."), [](FMcpSchemaBuilder& S) { S.Number(TEXT("x")).Number(TEXT("y")).Number(TEXT("z")); })
