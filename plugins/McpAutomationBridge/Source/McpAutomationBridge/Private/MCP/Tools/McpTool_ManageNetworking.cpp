...
public:
	...
	TSharedPtr<FJsonObject> BuildInputSchema() const override
	{
		return FMcpSchemaBuilder()
			...
			.StringEnum(TEXT("valueType"), { TEXT("Boolean"), TEXT("Axis1D"), TEXT("Axis2D"), TEXT("Axis3D") }, TEXT("Enhanced Input action value type."))
			.String(TEXT("chordActionPath"), TEXT("Input action path used by a Chorded trigger."))
			.Number(TEXT("lowerThreshold"), TEXT("Dead Zone lower threshold."))
			.Number(TEXT("upperThreshold"), TEXT("Dead Zone upper threshold."))
			.Number(TEXT("scalarX"), TEXT("Scalar modifier X value."))
			.Number(TEXT("scalarY"), TEXT("Scalar modifier Y value."))
			.Number(TEXT("scalarZ"), TEXT("Scalar modifier Z value."))
			.String(TEXT("swizzleOrder"), TEXT("Swizzle Axis order (YXZ, ZXY, etc.)."))
			.Bool(TEXT("negateX"), TEXT("Negate X axis."))
			.Bool(TEXT("negateY"), TEXT("Negate Y axis."))
			.Bool(TEXT("negateZ"), TEXT("Negate Z axis."))
			.Number(TEXT("holdTime"), TEXT("Hold trigger duration."))
			.Number(TEXT("tapTime"), TEXT("Tap trigger duration."))
