...
runToolTests('ai-navigation-authoring-ue58', [
  { scenario: 'Setup: create scoped navigation bounds', toolName: 'manage_ai', arguments: { action: 'create_nav_mesh_bounds', boundsActorName: bounds, location: { x: 0, y: 0, z: 0 }, extent: { x: 2500, y: 2500, z: 500 } }, expected: 'success', assertions: [{ path: 'structuredContent.result.created', equals: true, label: 'bounds was created' }] },
  { scenario: 'Setup: create an obstacle in the test arena', toolName: 'manage_level_structure', arguments: { action: 'create_nav_modifier_volume', volumeName: obstacle, location: { x: 0, y: 0, z: 100 }, extent: { x: 250, y: 1200, z: 300 }, areaClass: '/Script/NavigationSystem.NavArea_Obstacle' }, expected: 'success' },
