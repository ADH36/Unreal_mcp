  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        patternType: commonSchemas.stringProp,
        primaryColor: commonSchemas.objectProp,
        secondaryColor: commonSchemas.objectProp,
        tilesX: commonSchemas.numberProp,
        tilesY: commonSchemas.numberProp,
        lineWidth: commonSchemas.numberProp,
        brickRatio: commonSchemas.numberProp,
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        resolutionY: commonSchemas.numberProp,
        terrainFeature: { type: 'string', enum: ['mountains', 'hills', 'valleys', 'plains', 'lakeshore', 'erosion'], description: 'Procedural heightmap feature.' },
        placementMode: { type: 'string', enum: ['auto', 'landscape_grass', 'pcg', 'hism'], description: 'Requested scalable foliage placement backend.' },
        foliageName: commonSchemas.stringProp,
        exclusionZones: commonSchemas.arrayOfObjects,
        excludedActors: commonSchemas.arrayOfStrings,
        minSlope: commonSchemas.numberProp,
        maxSlope: commonSchemas.numberProp,
        minHeight: commonSchemas.numberProp,
        maxHeight: commonSchemas.numberProp,
        surfaceOffset: commonSchemas.numberProp,
        generatedOnly: commonSchemas.booleanProp,
        cancel: commonSchemas.booleanProp,
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        packagePaths: { type: 'array', items: commonSchemas.directoryPath, description: 'Alias for searchPaths.' },
        query: { type: 'string', description: 'Case-insensitive asset path/name query.' },
        suitableOnly: { type: 'boolean', description: 'Only return non-fallback tree/environment candidates.' },
        allowFallbackMesh: { type: 'boolean', description: 'Explicitly allow cube/basic-shape/fallback meshes.' },
        allowCube: { type: 'boolean', description: 'Alias for allowFallbackMesh.' },
        limit: commonSchemas.integerProp,
        offset: commonSchemas.integerProp,
        texturePath: commonSchemas.texturePath,
    ...
    outputSchema: {
      ...
      properties: {
        ...
        meshPath: commonSchemas.meshPath,
        actualMeshPaths: { type: 'array', items: commonSchemas.meshPath },
        actualMeshPackagePaths: { type: 'array', items: commonSchemas.meshPath },
        validAssets: { type: 'array', items: { type: 'object' } },
        invalidAssets: { type: 'array', items: { type: 'object' } },
        assets: { type: 'array', items: { type: 'object' } },
        valid: commonSchemas.booleanProp,
        validCount: commonSchemas.integerProp,
        invalidCount: commonSchemas.integerProp,
        count: commonSchemas.integerProp,
        candidateCount: commonSchemas.integerProp,
        ...
        transformHash: commonSchemas.stringProp,
        transformsWithinBounds: commonSchemas.booleanProp,
        materialized: commonSchemas.booleanProp,
        materializedInstanceCount: commonSchemas.integerProp,
        componentCount: commonSchemas.integerProp,
        ismComponentCount: commonSchemas.integerProp,
        hismComponentCount: commonSchemas.integerProp,
        hasFallbackMesh: commonSchemas.booleanProp,
  ...
  },
  {
    ...
    outputSchema: {
      ...
      properties: {
        ...
        hlodLayerPath: commonSchemas.hlodLayerPath,
        hlodLayers: commonSchemas.arrayOfObjects,
